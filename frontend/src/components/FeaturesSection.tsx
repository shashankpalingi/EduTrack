  ...
  const features = {
    teachers: [
      ...
      },
      {
        ...
        title: "Quiz Creation",
        description: "Create assessments and track results"
      },
      {
      ...
      },
      {
        ...
        title: "Communication",
        description: "Direct messaging with students and parents"
      }
    ],
    students: [
      {
        ...
        description: "Keep track of due dates and submissions"
      },
      {
      ...
      },
      {
        ...
        description: "Access course materials and study guides"
      }
    ],
    ai: [
      {
        ...
        description: "Get instant help with academic questions"
      },
      {
        icon: <Vote className="w-6 h-6 text-amber-500" />,
        title: "Smart Quiz Generation",
        description: "AI-powered assessments tailored to your needs"
      },
      {
        icon: <Clock className="w-6 h-6 text-amber-500" />,
        title: "Personalized Learning",
        description: "Adaptive content based on your progress"
      }
    ]
  };
