  ...
  const handleGoogleSignIn = async () => {
    try {
      ...
      toast({
        ...
        description: `You have been successfully logged in with Google as a ${role}.`,
      });
      // Navigation will happen automatically via the useEffect
    } catch (error: any) {
  ...
  const handleGithubSignIn = async () => {
    try {
      ...
      toast({
        ...
        description: `You have been successfully logged in with GitHub as a ${role}.`,
      });
      // Navigation will happen automatically via the useEffect
    } catch (error: any) {
            ...
            <div className="relative group">
              ...
              <div className="relative bg-black/50 backdrop-blur-xl rounded-2xl p-5 border border-white/[0.05] shadow-2xl overflow-hidden">
                ...
                <div className="text-center space-y-1 mb-4">
                  ...
                  >
                    {isLogin ? 'Sign in to continue to EduTrack' : 'Create your EduTrack account'}
                  </motion.p>
          </div>
                    ...
                    {!isLogin && (
                      ...
                      >
                        ...
                        <div className="relative overflow-hidden rounded-lg bg-white/5 p-3">
                          <div className="text-white/60 text-xs mb-2">I am a:</div>
                          <div className="flex space-x-3">
                            <button
                              type="button"
                              onClick={() => setRole('student')}
                              className={`flex-1 py-2 px-3 rounded-md text-sm transition-all duration-300 ${role === 'student' ? 'bg-white/20 text-white' : 'bg-white/5 text-white/60 hover:bg-white/10'}`}
                            >
                              Student
                            </button>
                            <button
                              ...
                              className={`flex-1 py-2 px-3 rounded-md text-sm transition-all duration-300 ${role === 'teacher' ? 'bg-white/20 text-white' : 'bg-white/5 text-white/60 hover:bg-white/10'}`}
                            >
                              Teacher
                            </button>
                          </div>
